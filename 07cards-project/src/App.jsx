...
const App = () => {
  ...
  return (
         <div className='parent'>
          {jobOpenings.map(function(value){
            return <Card company={value.companyName} logo={value.brandLogo} date={value.datePosted} post={value.post} tag1={value.tag1} tag2={value.tag2} pay={value.pay} location={value.location}/>
          })}
         </div>
  )
}
